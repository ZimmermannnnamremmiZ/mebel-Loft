                    ...
                    <div class="header__sections">
                        <div class="hamburger-menu">
                            ...
                            <div class="menu__box">
                                ...
                                <div class="menu__item menu__about"><a href="/site_pages/about_page/index.php">О нас</a>
                                </div>
                                ...
                                <div class="menu__item menu__kitchen"><a
                                        href="/site_pages/catalog_page/index.php">Кухни</a>
                                </div>
                                <div class="menu__item menu__bedroom"><a
                                        href="/site_pages/catalog_page/index.php">Спальни</a>
                                </div>
                                <div class="menu__item menu__livingroom"><a
                                        href="/site_pages/catalog_page/index.php">Гостинные</a></div>
                                <div class="menu__item menu__hallways"><a
                                        href="/site_pages/catalog_page/index.php">Прихожие</a>
                                </div>
                                <div class="menu__item menu__office"><a
                                        href="/site_pages/catalog_page/index.php">Офисная
                                        мебель</a></div>
                                <div class="menu__item menu__childrensroom"><a
                                        href="/site_pages/catalog_page/index.php">Детская</a></div>
                                <div class="menu__item menu__stock"><a
                                        href="/site_pages/catalog_page/index.php">Акция</a></div>
                                <div class="menu__item menu__novelty"><a
                                        href="/site_pages/catalog_page/index.php">Новинки</a>
                                </div>
                                <div class="menu__item menu__mattress"><a
                                        href="/site_pages/catalog_page/index.php">Матрасы</a>
                                </div>
                                <div class="menu__item menu__softFurniture"><a
                                        href="/site_pages/catalog_page/index.php">Мягкая
                                        мебель</a></div>
                                <div class="menu__item menu__cupboard"><a
                                        href="/site_pages/catalog_page/index.php">Шкафы</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <img class="header__searchLine-wishlist" src="/images/title_page/wishlist-icon.svg"
                            alt="search">
                ...
                <div class="about__flex-box">
                    <div class="about__textBlock">
                        ...
                        <div class="about__textBlock-text">
                            Уникальный формат интернет-магазина позволит вам купить лучшую мебель крупнейших российских
                            фабрик
                            максимально быстро и по выгодной цене! <br><br>Мы благодарим за доверие более десятка
                            производителей, которые дали нам возможность представлять лучшие образцы их продукции в
                            российском
            ...
            <div class="container">
                <section class="benefits">
                    ...
                    <div class="benefits__box ben_box_1">
                        <div class="benefits__item">
                            ...
                            <div class="benefits__item-textBox">
                                ...
                                <div class="benefits__item-text ">
                                    Предлагаем близкие к оптовым цены, которые дают <br>возможность приобретать мебель
                                    дешевле,
                        ...
                        <div class="benefits__item">
                            <img class="benefits__item-img car_delivery_img" src="/images/about_images/Vector.svg"
                                alt="empty">
                            <div class="benefits__item-textBox benefits__text_box№2">
                                ...
                                <div class="benefits__item-text">
                                    С ведущих мебельных фабрик уменьшают срок выполнения <br>вашего заказа, даже если
                                    речь идет
            ...
            <section class="advantages">
                ...
                <div class="advantages__item ai_2">
                    ...
                    <div class="advantages__item-text">
                        ...
                        контроль качества тщательно проверяет каждый образец перед отправкой заказчику. Покупатели
                        получают
                ...
                <section class="advantages2">
                    <div class="advantages2__box adv2_box_1">
                        <div class="advantages2__item">
                            ...
                            <div class="advantages2__item-text">
                                Число наших оптовых
                                покупателей неуклонно возрастает и всё потому, <br>что мы сумели предложить владельцам
                                мебельных
                        ...
                        <div class="advantages2__item">
                            <div class="advantages2__item-icon">
                                <img src="/images/about_images/delivery-box.svg" alt="empty"
                                    class="advantages2__item-img">
                            </div>
                            <div class="advantages2__item-title">
                    ...
                    <div class="advantages2__box adv2_box_2">
                        ...
                        <div class="advantages2__item">
                            ...
                            <div class="advantages2__item-text">
                                И мы благодарим всех, кто воспользовался нашим уникальным предложением, заказал мебель
                                быстро и
                    ...
                    <div class="footer__navigation-leftSide">
                        <div class="footer__navigation">
                            ...
                            <div class="footer__navigation-item">
                                <a class="footer__navigation-itemText"
                                    href="/site_pages/catalog_page/index.php">Кухни</a>
                                <a class="footer__navigation-itemText"
                                    href="/site_pages/catalog_page/index.php">Прихожие</a>
                                <a class="footer__navigation-itemText"
                                ...
                                <a class="footer__navigation-itemText"
                                    href="/site_pages/catalog_page/index.php">Матрасы</a>
                                <a class="footer__navigation-itemText"
                                    href="/site_pages/catalog_page/index.php">Гостинные</a>
                                <a class="footer__navigation-itemText"
                                    href="/site_pages/catalog_page/index.php">Детская</a>
                            ...
                            <div class="footer__navigation-item2">
                                ...
                                <a class="footer__navigation-newItems"
                                    href="/site_pages/catalog_page/index.php">Новинки</a>
                            </div>
                        </div>
                    </div>
                    <div class="footer__navigation-rightSide">
                        ...
                        <div class="footer__contacts-contacts">
                            <div class="footer__contacts-phone">
                                <img class='footer__contacts-phoneImg' src="/images/title_page/phone_in_footer.svg"
                                    alt="empty">
                            ...
                            <div class="footer__contacts-instagram">
                                <img class='footer__contacts-instagramImg' src="/images/title_page/inst.svg"
                                    alt="empty">
